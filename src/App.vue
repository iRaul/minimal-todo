<template>
  <div id="app">
    ...
    <a href="https://github.com/iRaul/vue-minimal-todo" target="_blank" class="github-corner" aria-label="View source on Github">
    ...
    <div class="container mx-auto">
      <div class="mx-auto w-full md:w-1/2 py-8 px-4">
        ...
        <div class="flex items-center mb-6">
          <h1 class="text-4xl text-white mr-6"><span>MINIMAL</span> TO DO</h1>
        ...
        <ul class="list-reset">
          <transition-group name="fade">
            <li v-for="(todo, i) in todos" :key="`${i}-${todo.id}`"
